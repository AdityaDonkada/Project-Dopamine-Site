      ...
      >
        <div>
          <div className="space-y-5 max-w-3xl mx-auto text-center">
            ...
            >
              Explore Project Dopamine
            </h1>
            <p className="max-w-xl mx-auto text-gray-300">
              Designed to block addictive content, our extension empowers you to
              stay focused, enhancing productivity and enriching your digital
              life.
            </p>
            <div className="flex items-center justify-center gap-x-3 font-medium text-sm">
              ...
              <a
                ...
                className="flex items-center gap-x-2 text-white bg-gray-800
                  hover:bg-gray-500 active:bg-gray-700 py-2.5 px-4 text-center
